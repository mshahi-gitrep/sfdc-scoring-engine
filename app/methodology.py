...
def render_methodology():
    ...
    st.markdown(
        ...
        "<p style='color:#64748B; margin:0; font-size:1.05rem; line-height:1.6;'>This appendix explains the business logic behind readiness scoring in a way that's transparent and auditable.</p>"
        "</div>",
    ...
    st.markdown(
        ...
        "<h3 style='margin:0 0 12px; color:#1E293B;'>Readiness Score Formula</h3>"
        "<p style='margin:0; color:#64748B; font-size:0.95rem;'>Readiness = (Engagement × 0.40) + (Recency × 0.25) + (Profile Fit × 0.20) + (Account Fit × 0.15)</p>"
        "</div>",
        unsafe_allow_html=True
    )
    ...
    with col1:
        st.markdown(
            "<div style='padding:22px; border-radius:14px; background:#F8FAFC; border:1px solid rgba(59,130,246,0.2);'>"
            "<div style='display:flex; align-items:flex-start; gap:10px; margin-bottom:14px;'>"
            "<span style='font-size:2rem;'>🎯</span>"
            "<div>"
            "<h4 style='margin:0; color:#1E293B;'>Engagement</h4>"
            "<p style='margin:4px 0 0; color:#64748B; font-size:0.85rem;'>Recent activity signal weight</p>"
            "</div>"
            "</div>"
    ...
    with col2:
        st.markdown(
            ...
            "<div>"
            "<h4 style='margin:0; color:#1E293B;'>Recency</h4>"
            "<p style='margin:4px 0 0; color:#64748B; font-size:0.85rem;'>Timeliness weight</p>"
            "</div>"
            "</div>"
    ...
    with col3:
        st.markdown(
            ...
            "<span style='font-size:2rem;'>👤</span>"
            "<div>"
            "<h4 style='margin:0; color:#1E293B;'>Profile Fit</h4>"
            "<p style='margin:4px 0 0; color:#64748B; font-size:0.85rem;'>Buyer profile weight</p>"
            "</div>"
            "</div>"
    ...
    with col4:
        st.markdown(
            ...
            "<span style='font-size:2rem;'>🏢</span>"
            "<div>"
            "<h4 style='margin:0; color:#1E293B;'>Account Fit</h4>"
            "<p style='margin:4px 0 0; color:#64748B; font-size:0.85rem;'>Account targeting weight</p>"
            "</div>"
            "</div>"
    ...
    st.markdown("")
    st.markdown(
        "<h2 style='color:#1E293B; margin-bottom:4px; font-size:1.3rem;'>Data Quality Rules</h2>"
        "<p style='color:#64748B; margin:0 0 20px;'>Records are automatically adjusted or blocked based on data integrity</p>",
        unsafe_allow_html=True
    )
    ...
    with col_dq1:
        st.markdown(
            ...
            "<h4 style='color:#EA8C1C; margin:0 0 12px;'>⚠️ Data Quality Flags</h4>"
    ...
    with col_dq2:
        st.markdown(
            "<div style='padding:20px; border-radius:14px; background:#F8FAFC; border:1px solid rgba(239,68,68,0.2);'>"
            "<h4 style='color:#DC2626; margin:0 0 12px;'>🚫 Compliance Blocks</h4>"
            "<ul style='margin:0; padding-left:20px; color:#64748B;'>"
    ...
    st.markdown("")
    st.markdown(
        "<h2 style='color:#1E293B; margin-bottom:4px; font-size:1.3rem;'>AI-Powered Insights</h2>"
        "<p style='color:#64748B; margin:0 0 20px;'>Deterministic agents explain the 'why' behind every recommendation</p>",
        unsafe_allow_html=True
    )

    st.markdown(
        "<div style='padding:20px; border-radius:14px; background:#F8FAFC; border:1px solid rgba(22, 163, 74, 0.15);'>"
        "<h4 style='color:#16A34A; margin:0 0 12px;'>✓ Guardrails Principle</h4>"
    ...
    st.markdown(
        ...
        "<h3 style='margin:0 0 12px; color:#1E293B;'>Why This Design Matters</h3>"
